...
export default function Navbar({ onNavigate, isLoggedIn, onShowLogin, user }) {
  return (
      ...
      <div className="flex items-center space-x-4 justify-end">
        ...
        {isLoggedIn && user ? (
          <>
            ...
            <button
              onClick={() => {
                localStorage.removeItem("move2getr_token"); // correction ici aussi !
